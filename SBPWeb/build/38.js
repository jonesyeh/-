...
var SchDayTimeServicesProvider = /** @class */ (function (_super) {
    ...
    SchDayTimeServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, keyword, order_type, sch_no) {
        var _this = this;
        if (sch_no === void 0) { sch_no = ""; }
        var sub_url;
        sub_url = "SchDayTime?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}&psch_no={5}";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchDayTimeViewModel__ = __webpack_require__(1098);
...
var SchDayTimePage = /** @class */ (function (_super) {
    ...
    SchDayTimePage.prototype.LoadData = function (init) {
        ...
        this.global.loading.present().then(function () {
            _this.SchDayTimeServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type, _this.sch_no).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchDayTimeViewModel__ = __webpack_require__(1098);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
