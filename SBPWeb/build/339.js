...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_path_services_file_path_services__ = __webpack_require__(269);
...
var JobLoopEventAddEditModalPage = /** @class */ (function () {
    ...
    JobLoopEventAddEditModalPage.prototype.SelectEventType = function () {
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            if (select_data.code_key == "078|TIME") {
                _this.item.period_min = 0;
            }
            else {
                _this.item.period_min = 1;
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_loop_event_add_edit_modal__ = __webpack_require__(1565);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
