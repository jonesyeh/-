...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportSqlAddEditPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileExportSqlStatementViewModel__ = __webpack_require__(300);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_file_export_sql_statement_services_file_export_sql_statement_services__ = __webpack_require__(301);
...
/**
 * Generated class for the FileexportSqlModalPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var FileExportSqlAddEditPage = /** @class */ (function () {
    function FileExportSqlAddEditPage(navCtrl, navParams, viewCtrl, modalCtrl, global, authServices, FileExportSqlStatementServices, alertCtrl) {
        ...
        this.FileExportSqlStatementServices = FileExportSqlStatementServices;
        ...
        this.item = new __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileExportSqlStatementViewModel__["a" /* FileExportSqlStatementViewModel */]();
    ...
    FileExportSqlAddEditPage.prototype.LoadData = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileExportSqlStatementServices.GetAsync(_this.item.exec_file_seq, _this.item.schemaname, _this.item.tablename, _this.item.db_conn_id, _this.item.parameter_column_group, _this.item.src_export_type_key).subscribe(function (data) {
    ...
    FileExportSqlAddEditPage.prototype.Save = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileExportSqlStatementServices.PostPutAsync(_this.item, _this.mode).subscribe(function (data) {
    ...
    FileExportSqlAddEditPage.prototype.Help = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
    ...
    FileExportSqlAddEditPage.prototype.openNavParameterColumnPage = function (item) {
        var _this = this;
    ...
    FileExportSqlAddEditPage.prototype.Delete = function (item) {
        var _this = this;
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.global.loading.present().then(function () {
                            _this.FileExportSqlStatementServices.DeleteAsync(_this.item.exec_file_seq, _this.item.schemaname, _this.item.tablename, _this.item.db_conn_id, _this.item.parameter_column_group, _this.item.src_export_type_key).subscribe(function (data) {
                                _this.global.dismissLoading();
                                if (data.DidError === false) {
    ...
    FileExportSqlAddEditPage.prototype.close = function () {
        this.navCtrl.pop();
        //  this.viewCtrl.dismiss();
    };
    FileExportSqlAddEditPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileExportSqlStatementServices.GetSqlAsync(_this.item.exec_file_seq, _this.item.schemaname, _this.item.tablename, _this.item.db_conn_id, _this.item.parameter_column_group, _this.item.src_export_type_key, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportSqlAddEditPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers_file_export_sql_statement_services_file_export_sql_statement_services__["a" /* FileExportSqlStatementServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], FileExportSqlAddEditPage);
    return FileExportSqlAddEditPage;
}());

//# sourceMappingURL=file-export-sql-add-edit.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileExportSqlAddEditPageModule", function() { return FileExportSqlAddEditPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_export_sql_add_edit__ = __webpack_require__(1422);
...
var FileExportSqlAddEditPageModule = /** @class */ (function () {
    function FileExportSqlAddEditPageModule() {
    }
    FileExportSqlAddEditPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_export_sql_add_edit__["a" /* FileExportSqlAddEditPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_export_sql_add_edit__["a" /* FileExportSqlAddEditPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExportSqlAddEditPageModule);
    return FileExportSqlAddEditPageModule;
}());

//# sourceMappingURL=file-export-sql-add-edit.module.js.map
