...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_file_ftp_down_services_file_ftp_down_services__ = __webpack_require__(1058);
...
var FileFtpDownAddEditModalPage = /** @class */ (function () {
    ...
    FileFtpDownAddEditModalPage.prototype.SelectFileProcType = function () {
        ...
        var modal = this.modalCtrl.create("CodeSelectModalPage", {
            ...
            code_key: "018|1,018|2,018|2A,018|2AR,018|2R,018|3,018|3A,018|3AR,018|3B,018|3BR,018|3R,018|4,018|4R,018|5,018|6,018|6A,018|6AR,018|6R,018|7,018|7A,018|7AR,018|7B,018|7BR,018|7R,018|8,018|8R,018|FTPDEL,018|LIST,018|LISTD,018|LISTDF"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
    ...
    FileFtpDownAddEditModalPage.prototype.SelectRerunFileProcType = function () {
        var _this = this;
        var modal = this.modalCtrl.create("CodeSelectModalPage", {
