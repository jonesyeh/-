...
var ConnHttpAddEditModalPage = /** @class */ (function () {
    function ConnHttpAddEditModalPage(navCtrl, navParams, viewCtrl, loadingCtrl, global) {
        ...
        this.global = global;
        this.sql_help = "\n\u53EF\u8F38\u5165\u4E0B\u9762\u65B9\u5F0F\nAuthorization \u5BC6\u78BC\u6B04\u4F4D\u8F38\u5165Token \u767B\u5165\u5E33\u865F:xxxxxxxxxx(\u4F8B\u5982:\u5E33\u865F=Authorization,\u5BC6\u78BC=Token admin:eyJhbGciOiJI)\nAuthorization \u5BC6\u78BC\u6B04\u4F4D\u8F38\u5165Bearer xxxxxxxxxx(\u4F8B\u5982:\u5E33\u865F=Authorization,\u5BC6\u78BC=eyJhbGciOiJI)\nNTLM:\u672C\u6A5F\u5E33\u865F \u5BC6\u78BC\u6B04\u4F4D\u8F38\u5165\u7D14\u5BC6\u78BC(\u4F8B\u5982:\u5E33\u865F=NTLM:admin,\u5BC6\u78BC=12345678)\nNTLM:\u7DB2\u57DF\u5E33\u865F \u5BC6\u78BC\u6B04\u4F4D\u8F38\u5165\u7D14\u5BC6\u78BC(\u4F8B\u5982:\u5E33\u865F=NTLM:SYSTEXadmin,\u5BC6\u78BC=12345678)\n\u7D14\u5E33\u865F \u5BC6\u78BC\u6B04\u4F4D\u8F38\u5165\u7D14\u5BC6\u78BC(\u4F8B\u5982:\u5E33\u865F=admin,\u5BC6\u78BC=12345678)\n  ";
    ...
    ConnHttpAddEditModalPage.prototype.Help = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.global.showMessage("帳號說明", _this.sql_help);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__conn_http_add_edit_modal__ = __webpack_require__(1335);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
