...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__directory_browser_directory_browser__ = __webpack_require__(1035);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__file_browser_file_browser__ = __webpack_require__(1036);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_file_path_services_file_path_services__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_auth_services_auth_services__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_file_saver__ = __webpack_require__(955);
...
var FileBrowserComponent = /** @class */ (function () {
    function FileBrowserComponent(menuCtrl, navCtrl, navParams, FileBrowserServices, loadingCtrl, global, modalCtrl, alertCtrl, FilePathServices, authServices, platform, conf, runjobServices) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    FileBrowserComponent.prototype.openNavFileLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("FileDateExecLogPage", { ssis_job_no: _this.ssis_job_no });
        });
    };
    FileBrowserComponent.prototype.openNavRunPage = function (item) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.runjobServices.RunJobAsync(_this.ssis_job_no)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_browser__ = __webpack_require__(1381);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_directory_browser_components_module__ = __webpack_require__(1034);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
} else if (("function" !== "undefined" && __webpack_require__(956) !== null) && (__webpack_require__(957) !== null)) {
