...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobListResponse__ = __webpack_require__(1206);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_JobResponse__ = __webpack_require__(1207);
    ...
    function JobListResponse(obj) {
        ...
        if (obj.DidError === false) {
            obj.Model.forEach(function (data) {
                ...
                item.is_upload_set = data.is_upload_set;
                if (item.is_upload_set === true)
                    item.is_upload_set_color = "danger";
                else
                    item.is_upload_set_color = "light";
                item.run_stop = data.run_stop;
    ...
    function JobResponse(obj) {
        ...
        if (_this.DidError === false) {
            if (obj.Model.ssis_job_no) {
                ...
                _this.Model.run_stop = obj.Model.run_stop;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_job_services_job_services__ = __webpack_require__(1087);
...
var JobPage = /** @class */ (function () {
    ...
    JobPage.prototype.openNavUploadSetPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("JobUploadSetAddEditPage", { item: item });
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job__ = __webpack_require__(1588);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(821);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_job_services_job_services__ = __webpack_require__(1087);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
